...
- [Use case diagram and use cases](#use-case-diagram-and-use-cases)
  - [Use case diagram](#use-case-diagram)
    - [Use case 1, UC1](#use-case-1-uc1)
      - [*Add products : manager wants to add products to the database*](#add-products-manager-wants-to-add-products-to-the-database)
...
#### *Add products : manager wants to add products to the database*
